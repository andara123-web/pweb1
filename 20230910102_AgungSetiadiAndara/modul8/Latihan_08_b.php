...
//Operator Aritmatika
$lamaKelulusan = $tahun Sekarang - $tahunKelulusan; 
$rasioAlumni = $jumlahLulusan Tahun / 150; // Misalkan 150 adalah total alumni
...
$initials = substr($namaAlumni, 0, 1).substr($namaAlumni, 
strpos($namaAlumni, " ") + 1, 1); 
